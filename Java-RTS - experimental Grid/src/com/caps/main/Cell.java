...
public class Cell extends CellObject{
	...
	private void setPartents(){
		parents.set(0, handler.cordsToCell(this.x, this.y - 20));
		parents.set(1, handler.cordsToCell(this.x, this.y + 20));
		parents.set(2, handler.cordsToCell(this.x - 20, this.y));
		parents.set(3, handler.cordsToCell(this.x + 20, this.y));
	}
}*/